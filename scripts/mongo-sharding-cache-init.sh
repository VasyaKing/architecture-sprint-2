...
echo "Configure redis cluster"
docker exec -i redis1 sh -c 'echo "yes" | redis-cli --cluster create 173.17.0.22:6379 173.17.0.23:6379 173.17.0.24:6379 173.17.0.25:6379 173.17.0.26:6379 173.17.0.27:6379 --cluster-replicas 1'

echo "Mongo sharded cluster with cache was initialized successfully."